...
## 📱Creating an app
I had previously built a few Flutter web projects and remembered that path navigation and route guarding are essential in web apps. To help solve this, I used [auto-route](https://pub.dev/packages/auto_route), as I have used this in most of my apps. I planned the navigation as follows:
...
<ImageCenter
  alt={`The get to know Iain feature in the app`}
