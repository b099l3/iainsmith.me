...
Perfect! Smooth UI and more efficient API calls. If you want the code, you can check it out on my GitHub [here](https://github.com/b099l3/Examples/tree/main/flutter-how-to-use-debounce-increment-control/debounce_bloc) Or if you want to chat about it hit me up on Twitter.
