...
<Image
  alt={`Future-proofing`}
  src={`/static/images/future-proof-your-flutter-env/banner.png`}
  width={1000}
  height={563}
  priority
/>
...
<ImageCenter
  ...
  src={`/static/images/future-proof-your-flutter-env/gif1.gif`}
  width={480}
  height={360}
/>
<Caption
...
<Alert
  type={`warn`}
  message={`Don't install each environment on top of each other, as you will have installed Flutter three times. I recommend only installing one solution.`}
/>
...
<ImageCenter
  ...
  src={`/static/images/future-proof-your-flutter-env/gif2.gif`}
  width={480}
  height={360}
/>
...
<Alert
  type={`info`}
  title={'Manual version switching'}
  message={`You can set up manual version switching by setting "dart.flutterSdkPaths":
  ["/Users/[Your User]/fvm/versions"]`}
/>
...
<ImageCenter
  ...
  src={`/static/images/future-proof-your-flutter-env/image-1.png`}
  width={1000}
  height={543}
/>
...
<ImageCenter
  alt={`FVM is amazing!`}
  src={`/static/images/future-proof-your-flutter-env/gif3.gif`}
  width={480}
  height={360}
/>
...
<ImageCenter
  ...
  src={`/static/images/future-proof-your-flutter-env/gif4.gif`}
  width={480}
  height={360}
/>
<Caption
...
<ImageCenter
  ...
  src={`/static/images/future-proof-your-flutter-env/gif5.gif`}
  width={480}
  height={360}
/>
...
<ImageCenter
  ...
  src={`/static/images/future-proof-your-flutter-env/gif6.gif`}
  width={480}
  height={360}
/>
...
<AlertWithImage
  type={`info`}
  title={`VSCode Error`}
  image={'/static/images/future-proof-your-flutter-env/vscode-error.png'}
  message={`If you are using VSCode and see this error, you can set the FLUTTER_ROOT environment variable:
  <br/>
  <code>export FLUTTER_ROOT="$(asdf where flutter)</code>"`}
/>
...
<ImageCenter
  ...
  src={`/static/images/future-proof-your-flutter-env/gif7.gif`}
  width={480}
  height={360}
/>
